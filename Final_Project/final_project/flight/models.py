...
class Flight(models.Model):
    airport_to = models.ForeignKey('airport.Airport', related_name='arriving_flights', on_delete=models.CASCADE,null=True, blank=True)
    airport_from = models.ForeignKey('airport.Airport', related_name='departing_flights', on_delete=models.CASCADE,null=True, blank=True)
